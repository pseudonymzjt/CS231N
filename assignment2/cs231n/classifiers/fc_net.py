    ...
    def loss(self, X, y=None):
        ...
        for i in range(num - 1):
            if self.normalization == None:
                ...
                middle[i + 1], cache[i + 1] = affine_layernorm_relu_forward(middle[i], self.params['W' + str(i + 1)], self.params['b' + str(i + 1)], 
                                                                                       self.params['gamma' + str(i + 1)], self.params['beta' + str(i + 1)], self.ln_params[i])
        scores, cache[num] = affine_forward(middle[num - 1], self.params['W' + str(num)], self.params['b' + str(num)])
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        loss += 0.5 * self.reg * (sum(np.sum(self.params['W' + str(i)] * self.params['W' + str(i)]) for i in range(1, num + 1)))
        dmiddle[num - 1], grads['W' + str(num)], grads['b' + str(num)] = affine_backward(dscores, cache[num])
        ...
        for i in range(num - 2, -1, -1):
            if self.normalization == None:
                ...
                dmiddle[i], grads['W' + str(i + 1)], grads['b' + str(i + 1)], grads['gamma' + str(i + 1)], grads['beta' + str(i + 1)] = affine_layernorm_relu_backward(dmiddle[i + 1], cache[i + 1])
                grads['W' + str(i + 1)] += self.reg * self.params['W' + str(i + 1)] 
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
